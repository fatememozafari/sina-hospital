            ...
            <div class="slim_scroll">
                ...
                <div class="card">
                    ...
                    <ul class="list-unstyled theme-light-dark">
                        ...
                        <li>
                            <div class="t-dark btn btn-default btn-round">تاریک</div>
                        </li>
                    </ul>
                </div>
{{--                <div class="card">--}}
            ...
            <div class="slim_scroll">
                ...
                <div class="card">
                    ...
                    <div class="progress-container progress-primary">
                        <span class="progress-badge">جراحی قلب</span>
                        <div class="progress">
                        ...
                        <ul class="list-unstyled team-info">
                            ...
                            <li>
                                <img src="{{asset('assets/images/xs/avatar2.jpg')}}" alt="آواتار">
                            </li>
                            <li>
                                <img src="{{asset('assets/images/xs/avatar3.jpg')}}" alt="آواتار">
                            </li>
                            <li>
                                <img src="{{asset('assets/images/xs/avatar4.jpg')}}" alt="آواتار">
                            </li>
                        </ul>
                    </div>
                    <div class="progress-container">
                        <span class="progress-badge">پزشکی</span>
                        <div class="progress">
                        ...
                        <ul class="list-unstyled team-info">
                            <li class="m-l-15"><small>تیم</small></li>
                            <li>
                                <img src="{{asset('assets/images/xs/avatar10.jpg')}}" alt="آواتار">
                            </li>
                            <li>
                                <img src="{{asset('assets/images/xs/avatar9.jpg')}}" alt="آواتار">
                            </li>
                            <li>
                                <img src="{{asset('assets/images/xs/avatar8.jpg')}}" alt="آواتار">
                            </li>
                            <li>
                                <img src="{{asset('assets/images/xs/avatar7.jpg')}}" alt="آواتار">
                            </li>
                            <li>
                                <img src="{{asset('assets/images/xs/avatar6.jpg')}}" alt="آواتار">
                            </li>
                        </ul>
                    </div>
                    <div class="progress-container progress-warning">
                        <span class="progress-badge">داروخانه</span>
                        <div class="progress">
                        ...
                        <ul class="list-unstyled team-info">
                            <li class="m-l-15"><small>تیم</small></li>
                            <li>
                                <img src="{{asset('assets/images/xs/avatar5.jpg')}}" alt="آواتار">
                            </li>
                            <li>
                                <img src="{{asset('assets/images/xs/avatar2.jpg')}}" alt="آواتار">
                            </li>
