            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="/admin/documents/{{$inputs->id}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12"><b>نام مدرس</b>
                                        <div class="form-group">
                                            {{--                                            <input type="text" name="teacher_id" value="{{$inputs->teacher_id}}" class="form-control" placeholder="نام مدرس">--}}
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12"><b>آپلود فایل</b>
                                    <form action="http://www.wrraptheme.com/" id="frmFileUpload" class="dropzone" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="fallback">
                                            <input name="file" type="file" value="{{$inputs->file}}" multiple />
                                        </div>
                                    </form>
                                </div>
                                <hr>
