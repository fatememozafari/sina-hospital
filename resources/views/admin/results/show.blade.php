...
<section class="content home container" style="width: 80%;">
    ...
    <div class="container" style="width: 90%">
        <div class="row flex-column text-right">
            ...
            <div class="d-flex justify-content-between ">
                <p> به شماره پرسنلی: {{$user->personnel_number}}</p>
                <p> پست سازمانی: {{$user->job}}</p>
                <p> کد شغل: {{$user->job_code}}</p>
        ...
        <table class="table table-bordered text-center">
            ...
            <tr>
                ...
                <th style="width: 133.7031px;">نام تخصصی دوره آموزشی</th>
                <th style="width: 100.7031px;">نوع دوره</th>
                <th style="width: 100.7031px;">تاریخ برگزاری</th>
                <th style="width: 33.7031px;">مدت دوره به ساعت</th>
                <th style="width: 50.7031px;">امتیاز آزمون پایان دوره</th>
            ...
            @foreach($score as $item)
                <tr>
                    ...
                    <td>{{__('custom.'.$item->course->type)}}</td>
