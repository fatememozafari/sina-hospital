            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="/admin/questions/{{$inputs->id}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12"><b>آپلود تصویر</b>
                                        <div class="form-group">
                                            <input type="file" name="avatar_path" value="{{$inputs->avatar_path}}" class="form-control" placeholder="پاسخ">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
