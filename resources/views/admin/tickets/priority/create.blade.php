...
{{--                        <small class="text-muted">خوش امدید</small>--}}
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb float-md-left">
                        ...
                        <li class="breadcrumb-item active float-right"> ثبت اولویت بندی جدید</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{route('admin.tickets.priorities.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row clearfix">
