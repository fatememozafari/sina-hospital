                    ...
                    <div class="col-lg-5 col-md-6 col-sm-12">
                        ...
                        <ul class="breadcrumb float-md-left">
                            <li class="breadcrumb-item float-right"><a href="{{route('admin.dashboard')}}"><i
                                    ...
                                    خانه</a></li>
                            <li class="breadcrumb-item active float-right"> اولویت بندی </li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <!-- Exportable Table -->
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>لیست اولویت بندی های تیکت </strong></h2>
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a class="btn btn-info" href="{{route('admin.tickets.priorities.create')}}">ایجاد اولویت بندی جدید</a>
                                    </li>
                                    <li class="remove">
                                    ...
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_1"
                                                ...
                                                aria-label="نام اولویت بندی: activate to sort column descending"
                                                style="width: 133.453px;">نام اولویت بندی
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                                rowspan="1" colspan="1"
...
{{--                                        </tfoot>--}}
                                        ...
                                        @foreach($ticketPriorities as $key => $ticketPriority)
                                            <tr role="row" class="even">
                                                <td>{{ $key += 1 }}</td>
                                                <td class="sorting_1">{{$ticketPriority->name}}</td>
                                                <td>{{$ticketPriority->status}}</td>
                                                <td>
                                                    <div style="display: flex" >
                                                        <a href="{{route('admin.tickets.priorities.edit',$ticketPriority->id)}}" class="btn-sm text-info mt-3">ویرایش
                                                        </a>
                                                        <form action="{{route('admin.tickets.priorities.delete',$ticketPriority->id)}}" class="mt-2" method="post">
                                                            @csrf
