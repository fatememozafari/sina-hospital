                        ...
                        <div class="card">
                            <div class="header">
                                ...
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a class="btn btn-info" href="{{route('admin.tickets.categories.create')}}">ایجاد دسته بندی جدید</a>
                                    </li>
                                    <li class="remove">
                                    ...
                                    <table
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_1"
                                                ...
                                                style="width: 133.453px;">نام دسته بندی
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                                rowspan="1" colspan="1"
...
{{--                                        </tfoot>--}}
                                        ...
                                        @foreach($ticketCategories as $key => $ticketCategory)
                                            <tr role="row" class="even">
                                                <td>{{ $key += 1 }}</td>
                                                <td class="sorting_1">{{$ticketCategory->name}}</td>
