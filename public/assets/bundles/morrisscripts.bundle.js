    ...
    return function(i) {
        ...
        r = [i(2)], void 0 === (n = function(z) {
            ...
            function D(t, e, i, r, n, s) {
                this.f = null != t ? (this.a = +t, this.b = +e, this.c = +i, this.d = +r, this.e = +n, +s) : (this.a = 1, this.b = 0, this.c = 0, this.d = 1, this.e = 0)
            }
                    ...
                    for (var s = Mt(t), o = e && Mt(e), r = {
                            ...
                            switch (!(t[0] in {
                                ...
                                case "S":
                                    ...
                                    break;
                                case "T":
                                    e.qy = "Q" == i || "T" == i ? (e.qx = 2 * e.x - e.qx, 2 * e.y - e.qy) : (e.qx = e.x, e.y), t = ["C"][j](Ft(e.x, e.y, e.qx, e.qy, t[1], t[2]));
                                    break;
                                case "Q":
                ...
                var $, Z = function(t, e, i) {
                    ...
                    Q = function(t, e, i) {
                        ...
                        if (t = t.shape || t.node, a.length) {
                            ...
                            i.colors = h.length ? h.join() : "0% " + i.color, i.angle = "radial" == n ? (i.type = "gradientTitle", i.focus = "100%", i.focussize = "0 0", i.focusposition = s, 0) : (i.type = "gradient", (270 - o) % 360), t.appendChild(i)
                        }
                        return 1
                    },
                    d = function(t, e) {
