! function(n) {
    ...
    function yt(t) {
        ...
        for (a = function(t) {
            ...
            for (e = 0, n = (a = s[i = u[t][0]].aDataSort).length; e < n; e++) o = s[r = a[e]].sType || "string", u[t]._idx === j && (u[t]._idx = P.inArray(u[t][1], s[r].asSorting)), l.push({
                src: i,
                col: r,
                dir: u[t][1],
                index: u[t]._idx,
            ...
            return this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) Rt(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    if (-1 !== P.inArray(!0, P.map(t, function(t) {
                            return h.hasClass(t)
                        })) && (P("tbody tr", this).removeClass(t.join(" ")), c.asDestroyStripes = t.slice()), t = [], 0 !== (l = this.getElementsByTagName("thead")).length && (B(c.aoHeader, l[0]), t = U(c)), null === a.aoColumns)
    ...
    Xt("columns()", function(e, n) {
        ...
        oLanguage: {
            ...
            sEmptyTable: "هیچ داده قابل استفاده ای در جدول وجود ندارد ",
            sInfo: "نمایش سطر _START_ تا _END_از _TOTAL_ سطر",
            sInfoEmpty: "نمایش 0 تا 0 سطر از 0 سطر",
            ...
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "هیچ سطری با نتایج قابل قبول یافت نشد "
        },
